...
export class AppComponent implements OnInit {
  ...
  public application1: Application = new Application(1, 'Janez', 'Novak', 'janez.novak@gmail.com', '031333333', 17, "13.11.2022", "13.11.2022", "Muta-Vuzenica", "Grd si matic", ApplicationStatusEnum.Sent, TransportTypeEnum.PassangersTransport, "Ford Transit", 500.2, 10);
  public application2: Application = new Application(2, 'Janez', 'Novak', 'janez.novak@gmail.com', '031333333', 7, "20.9.2022", "20.9.2022", "Maribor-Graz - SG - Vuzenica - DRG - KOper - lepotec - lep - safdsdgf-g fdsg-d fg-dfg -dfg-d gasda sgdwe4srydx", "Eva ni lepa", ApplicationStatusEnum.Processing, TransportTypeEnum.GoodsTransport, "Ford Transit", 500.2, 10);
  public application3: Application = new Application(3, 'Janez', 'Novak', 'janez.novak@gmail.com', '031333333', 2, "25.12.2022", "27.12.2022", "Vuzenica-Benetke", "Tim je najlepši", ApplicationStatusEnum.Accepted, TransportTypeEnum.OneDayTrip, "Ford Transit", 500.2, 10);
